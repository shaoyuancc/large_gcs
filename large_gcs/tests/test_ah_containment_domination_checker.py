...
def test_nullspace_polyhedron_and_transformation_from_HPoly_and_T_correct_shapes_cg_trichal4():
    ...
    # fmt: off
    cand_path = ['source', "('NC|obs0_f0-obj0_v3', 'NC|obs0_f0-rob0_v1', 'NC|obj0_f3-rob0_v0')", "('NC|obs0_f0-obj0_v3', 'NC|obs0_f0-rob0_v1', 'NC|obj0_v0-rob0_f0')", "('NC|obs0_v1-obj0_f3', 'NC|obs0_f0-rob0_v1', 'NC|obj0_v0-rob0_f0')"]
    alt_path = ['source', "('NC|obs0_f0-obj0_v3', 'NC|obs0_f0-rob0_v1', 'NC|obj0_f3-rob0_v0')", "('NC|obs0_v1-obj0_f3', 'NC|obs0_f0-rob0_v1', 'NC|obj0_f3-rob0_v0')", "('NC|obs0_v1-obj0_f3', 'NC|obs0_f0-rob0_v1', 'NC|obj0_v0-rob0_f0')"]
    # fmt: on
...
def test_construct_path_from_nullspaces_reaches_new_cg_trichal4():
    graph_file = ContactGraphGeneratorParams.inc_graph_file_path_from_name(
        "cg_trichal4"
    )
    cg = IncrementalContactGraph.load_from_file(
...
def test_construct_path_from_nullspaces_reaches_cheaper_cg_trichal4():
    graph_file = ContactGraphGeneratorParams.inc_graph_file_path_from_name(
        "cg_trichal4"
    )
    cg = IncrementalContactGraph.load_from_file(
...
@pytest.mark.slow_test
def test_construct_path_from_nullspaces_reaches_new_last_pos_cg_trichal4():
    graph_file = ContactGraphGeneratorParams.inc_graph_file_path_from_name(
        "cg_trichal4"
    )
    cg = IncrementalContactGraph.load_from_file(
...
@pytest.mark.slow_test
@pytest.mark.skip(reason="Not Implemented Yet")
def test_construct_path_from_nullspaces_reaches_cheaper_last_pos_cg_trichal4():
    graph_file = ContactGraphGeneratorParams.inc_graph_file_path_from_name(
        "cg_trichal4"
    )
    cg = IncrementalContactGraph.load_from_file(
...
def test_polyhedrons_are_the_same_cg_trichal4():
